...
def get_rejection_trends():
    ...
    try:
        ...
        with conn.cursor() as cursor:
            ...
            # Define rejection categories (remains the same)
        ...
        app.logger.error(f"Error generating rejection trends: {e}", exc_info=True)
...
def export_rejection_trends():
    ...
    rejection_stage = config.get('rejectionStage', 'both') # Get the stage
