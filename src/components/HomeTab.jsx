  ...
  return (
    <div className="p-4">
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-soft mb-6">
        <h2 className="text-2xl font-semibold mb-4 text-center">Ring Lifecycle</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-gray-800 p-4 rounded-2xl shadow-soft">
          <h2 className="text-xl font-semibold mb-2">Ring Status Overview</h2>
        ...
        {/* Rejection Reasons */}
        <div className="bg-white dark:bg-gray-800 p-4 rounded-2xl shadow-soft">
          <h2 className="text-xl font-semibold mb-2">Rejection Reasons</h2>
          {data.rejectionReasonData?.length > 0 ? <ResponsiveContainer width="100%" height={400}><BarChart data={data.rejectionReasonData} layout="vertical"><CartesianGrid strokeDasharray="3 3" /><XAxis type="number" /><YAxis type="category" dataKey="name" width={150} /><Tooltip /><Legend /><Bar dataKey="value" fill="#82ca9d" /></BarChart></ResponsiveContainer> : renderNoData()}
        </div>

        {/* Rings by Size */}
        <div className="bg-white dark:bg-gray-800 p-4 rounded-2xl shadow-soft">
          <h2 className="text-xl font-semibold mb-2">Rings by Size</h2>
        ...
        {/* Rings by SKU */}
        <div className="bg-white dark:bg-gray-800 p-4 rounded-2xl shadow-soft">
          <h2 className="text-xl font-semibold mb-2">Rings by SKU</h2>
        ...
        {/* Rings by PCB Batch */}
        <div className="bg-white dark:bg-gray-800 p-4 rounded-2xl shadow-soft">
          <h2 className="text-xl font-semibold mb-2">Rings by PCB Batch</h2>
        ...
        {/* QC Person Yield */}
        <div className="bg-white dark:bg-gray-800 p-4 rounded-2xl shadow-soft">
          <h2 className="text-xl font-semibold mb-2">QC Person Yield</h2>
